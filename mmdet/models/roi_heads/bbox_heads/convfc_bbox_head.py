    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                elif type(self.loss_var).__name__ == 'L1Loss' or type(self.loss_var).__name__ == 'SmoothL1Loss': # Energy Score
                    forecaster_cholesky = self.covariance_output_to_cholesky(pos_bbox_var)
    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            if pos_inds.any():
                ...
                losses_var = self.loss_var(pos_bbox_var, avg_factor=pos_bbox_var.size(0),reduction_override=reduction_override)
                ...
                return dict(loss_roi_rank=ranking_loss, loss_roi_sort=sorting_loss, loss_roi_bbox=losses_bbox, loss_var=losses_var), bbox_weights
